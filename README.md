...
Semantic HTML is a markup used to introduce meaning to a web page rather than just presentation.
...
Git is valuable to a team of developers because it allows each individual developer view and work on the same projects simultaneously.  

5. Define mobile-first design in your own words.

Mobile-first design is when you start designing a webpage using smaller "mobile" screen sizes frist, and then start desiging using larger screens after that.
